...
styles/css: $(STYLUS_FILES)
	stylus --include-css styles/incomingcall.styl -o styles

styles/min.css: styles/css
	cssmin styles/*.css > styles/incomingcall.min.css

node_modules/bdsft-webrtc-styles.js: styles/min.css
	node_modules/webrtc-core/scripts/export-style styles/incomingcall.min.css node_modules/bdsft-webrtc-styles.js
